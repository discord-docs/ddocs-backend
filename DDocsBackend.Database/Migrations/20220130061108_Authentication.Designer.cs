...
namespace DDocsBackend.Data.Migrations
{
    ...
    [Migration("20220130061108_Authentication")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DDocsBackend.Data.Models.Authentication", b =>
                {
                    ...
                    b.Property<decimal?>("DiscordAuthenticationUserId")
                        .HasColumnType("numeric(20,0)");
                    ...
                    b.HasIndex("DiscordAuthenticationUserId");
            ...
            modelBuilder.Entity("DDocsBackend.Data.Models.DiscordOAuthAuthentication", b =>
                {
                    ...
                    b.ToTable("DiscordOAuthAuthentication");
                });
            ...
            modelBuilder.Entity("DDocsBackend.Data.Models.Authentication", b =>
                {
                    b.HasOne("DDocsBackend.Data.Models.DiscordOAuthAuthentication", "DiscordAuthentication")
                        .WithMany()
                        .HasForeignKey("DiscordAuthenticationUserId");
